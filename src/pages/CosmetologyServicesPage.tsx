...
const CosmetologyServicesPage: React.FC = () => {
  const services = [
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-6">
            ...
            <p className="text-xl text-white/90 font-light max-w-2xl">
              Профессиональный уход за вашей красотой с использованием передовых методик
            </p>
          </div>
        </div>
      </div>
...
export default CosmetologyServicesPage; 